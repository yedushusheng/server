...
public:
  ...
  Item* element_index(uint i) override { return this_item()->element_index(i); }
...
public:
  ...
  const Type_handler *type_handler() const override
  { return &type_handler_null; }
  bool basic_const_item() const override { return 1; }
...
public:
  ...
  */
  ...
  bool append_for_log(THD *thd, String *str) override;
  bool check_vcol_func_processor(void *int_arg) override {return FALSE;}
  Item *get_copy(THD *thd) override { return 0; }
...
public:
  Item_timestamp_literal(THD *thd)
   :Item_literal(thd)
  { }
  const Type_handler *type_handler() const override { return &type_handler_timestamp2; }
  int save_in_field(Field *field, bool no_conversions) override
  {
...
public:
  ...
  */
  ...
  enum Type real_type() const override  { return ref ? (*ref)->type() :
                                          REF_ITEM; }
  bool eq(const Item *item, bool binary_cmp) const override
  { 
...
public:
  ...
  enum Type type() const override { return EXPR_CACHE_ITEM; }
  enum Type real_type() const override { return orig_item->type(); }
...
public:
  ...
  bool save_in_param(THD *thd, Item_param *param) override
  {
  ...
  Item *get_tmp_table_item(THD *thd) override { return this; }
  Item_field *field_for_view_update() override { return 0; }
  bool update_vcol_processor(void *arg) override { return 0; }
  bool check_func_default_processor(void *arg) override { return true; }
  ...
  Item *transform(THD *thd, Item_transformer transformer, uchar *args) override;
};
...
public:
  ...
  { }
  enum Type type() const override { return CONTEXTUALLY_TYPED_VALUE_ITEM; }
  bool vcol_assignment_allowed_value() const override { return true; }
  bool eq(const Item *item, bool binary_cmp) const override
  {
    return false;
...
Item_trigger_field(THD *thd, Name_resolution_context *context_arg,
  ...
  Field *get_tmp_table_field() override { return 0; }
  Item *copy_or_same(THD *thd) override { return this; }
...
public:
  bool unknown_splocal_processor(void *arg) override { return false; }
  bool check_vcol_func_processor(void *arg) override;
};
